...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": constants.QINNIU_URL + self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": constants.QINNIU_URL + self.user.avatar_url if self.user.avatar_url else "",
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(constants.QINNIU_URL + image.url)
...
class Order(BaseModel, db.Model):
    ...
    alipay_on = db.Column(db.String(80))
